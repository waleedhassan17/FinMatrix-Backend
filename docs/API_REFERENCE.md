...
| | |
|---|---|
| Base URL (production) | `https://finmatrix-api-a824f23fbd72.herokuapp.com/api/v1` |
...
- [ ] Set `VITE_API_BASE_URL=https://finmatrix-api-a824f23fbd72.herokuapp.com/api/v1` (or `http://localhost:3000/api/v1`).
